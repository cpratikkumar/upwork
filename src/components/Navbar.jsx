...
<div className='left-side-div lg:w-[20%] lg:h-[50px] rounded-xl border-[1px] md:w-[35%] md:h-[50px] md:ml-10 lg:-ml-10 sm:w-[50%] sm:h-[50px] md:-mt-2 sm:mt-5 sm:-ml-0 border-gray-300 flex justify-around items-center bg-white shadow-slate-100 shadow-md'>
...
<div className='right-side-div-body lg:flex lg:w-[25%] h-[80px] justify-evenly items-center md:hidden lg:-mr-10'>
   <div className='rounded-xl border-[1px] border-gray-300 w-[40%] h-[50px] flex items-center justify-center mr-5 bg-white shadow-slate-100 shadow-md sm:hidden md:hidden lg:block'><button className=' font-medium hover:bg-gray-100 w-[95%] h-[40px] m-1 rounded-lg font-jakarta'>Contact Sales</button></div>
   <div className='rounded-xl border-[1px] border-gray-300 w-[50%] h-[50px] flex items-center justify-evenly bg-white shadow-slate-100 shadow-md sm:hidden md:hidden lg:flex'>
    ...
    <div className='right-side-div-body flex w-[25%] h-[80px] justify-evenly  md:mr-8 items-center lg:hidden'>
      <button className='rounded-xl bg-gradient-to-r from-indigo-400 to-cyan-400 mx-1 font-jakarta border-[1px] font-medium text-white md:w-[40%] md:h-[40px] sm:w-[60%] sm:h-[40px] mr-0 ml-2 sm:mr-8'>Sign Up</button>
      <div className='rounded-xl w-[6vw] border-[1px] h-[40px] -ml-8'><img src="https://www.freeiconspng.com/uploads/menu-icon-6.png" alt="hamburger" className=' w-[50px] h-[50px] sm:w-[50px] -mt-1 ml-1 sm:ml-0'/></div>
      </div>     
    </div>
  )
}
